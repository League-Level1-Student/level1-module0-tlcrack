...
if(i==0&&guess.equalsIgnoreCase("arnold")||i==1&&guess.equalsIgnoreCase("leonardo")||i==2&&guess.equalsIgnoreCase("morgan")||i==3&&guess.equalsIgnoreCase("jack")) {
			score += 1;
	JOptionPane.showMessageDialog(null, "correct, intelligent carbon-based life form!");}
			// 6. Otherwise:
			// -- Tell them they are wrong and who the person is
else {	
JOptionPane.showMessageDialog(null, "incorrect, non-celebrity-knowing weirdo!");}

			// 7. Use the showNextImage() method below to get the next image
			showNextImage();
		    // 8. Show them their current score
			JOptionPane.showMessageDialog(null, "yer score be " + score + ", matey!");
